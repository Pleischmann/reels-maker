                          ...
                          {reel.shots.map((shot, i) => (
                            <div key={i} className="flex-shrink-0 w-[168px]">
                              <div className="relative rounded-xl overflow-hidden bg-black" style={{ aspectRatio: "9/16" }}>
                                ...
                                />
                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent pt-8 pb-2.5 px-2">
                                  <p className="text-white text-[13px] font-bold leading-tight drop-shadow-[0_1px_4px_rgba(0,0,0,0.9)]">{shot.caption}</p>
                                </div>
